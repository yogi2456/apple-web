...
<div className='navbar'>
        ...
        <div className='image'>
            ...
            <div className='watchi1'>
                ...
                <div className='image3'>
                    ...
                    <p>Available next year in the U.S.</p>
                    <div className='girl1'>
                        <p>Learn more</p>
                        <p><i class="fa-solid fa-chevron-right fa-l" style={{color: "#145fe1"}}></i></p>
                    </div>
        ...
        <div className='full'>
            <div className='full1'>
            <img style={{width: "100%", height: "100%"}} src='https://is1-ssl.mzstatic.com/image/thumb/-AiwUH5SvHJdsktfhM7pAw/1250x703.jpg'/>
            </div>
        </div>
